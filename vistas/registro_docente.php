    ...
    <main>
      ...
      <section class="contenedor">
        <div class="contenedor_2">
          ...
          <form action="../include/registrarDocente.php" target="" method="POST" name="formDocente" onsubmit="return validar();">            
            <?php
            $sexo = "";
            ?>
            ...
            <input type="submit" name="enviar_docente"  value="Registrar">
